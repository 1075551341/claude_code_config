...
description: 代码重构和清理专家，识别代码坏味道、安全重构、消除死代码和重复、代码简化与精炼。当需要重构遗留代码、消除代码坏味道、清理死代码、消除重复代码、提升代码可维护性、代码简化、KISS原则应用、代码瘦身时调用此Agent。触发词：重构、代码重构、技术债、坏味道、遗留代码、代码清理、消除重复、死代码、refactor-clean、代码简化、消除冗余、KISS原则、代码瘦身。
model: inherit
color: teal
tools:
  - Read
