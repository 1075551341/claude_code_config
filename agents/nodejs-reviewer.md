...
description: 负责Node.js和TypeScript后端代码审查任务。当需要审查Node.js代码、Review TypeScript后端代码、检查Express/Koa/Fastify/NestJS代码质量、评审后端API实现、审查数据库操作代码、检查异步处理逻辑、评估后端代码安全性和性能时调用此Agent。触发词：审查Node、Node.js审查、TypeScript审查、后端代码审查、Express审查、NestJS审查、Koa审查、审查后端代码、Node代码质量、后端Review。
model: inherit
color: yellow
tools:
  - Read
