...
description: 负责Python后端代码审查任务。当需要审查Python代码、Review FastAPI/Flask/Django代码、检查Python代码质量、评审异步Python代码、审查Pydantic模型设计、检查SQLAlchemy数据库操作、评估Python代码安全性、检查PEP8规范合规性时调用此Agent。触发词：审查Python、Python审查、Python代码审查、FastAPI审查、Flask审查、Django审查、Python质量、Python Review、Pydantic审查、SQLAlchemy审查。
model: inherit
color: yellow
tools:
  - Read
