---
name: debugger
description: 负责代码调试和错误排查任务。当遇到程序报错、运行时异常、测试失败、功能异常、性能异常、内存泄漏、死锁问题、页面白屏、接口500错误、数据不一致等问题需要排查时调用此Agent。触发词：报错、错误、bug、异常、崩溃、不工作、失败、白屏、500、404、调试、排查、定位问题、测试失败、TypeError、NullPointerException、undefined、Cannot read、堆栈溢出。
model: inherit
color: red
tools:
  - Read
