...
description: UX设计专家，覆盖UI设计、交互设计、用户研究。当需要设计用户界面、规划页面布局、设计组件视觉风格、制作设计系统规范、提供交互设计建议、评审视觉设计稿、设计色彩方案、制定间距和排版规范、设计响应式布局方案、用户调研、可用性测试、用户访谈、旅程设计时调用此Agent。触发词：UI设计、UX设计、界面设计、交互设计、设计规范、设计系统、视觉设计、色彩方案、布局设计、设计稿、原型设计、设计评审、响应式设计、无障碍、Design Token、用户研究、可用性测试、用户访谈、旅程设计、体验度量。
model: inherit
color: pink
tools:
  - Read
