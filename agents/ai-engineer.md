---
name: ai-engineer
description: 负责AI/LLM相关开发任务。当需要集成大语言模型API、构建RAG检索增强生成系统、设计Prompt工程方案、开发AI聊天机器人、实现AI功能模块、处理向量数据库、构建AI Agent、优化AI输出质量、评估AI模型效果时调用此Agent。触发词：AI开发、LLM、大模型、ChatGPT、Claude API、OpenAI、RAG、向量数据库、Prompt工程、AI集成、嵌入向量、AI Agent、Langchain、AI功能、智能助手。
model: inherit
color: purple
tools:
  - Read
