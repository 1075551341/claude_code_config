...
> 自动生成 | 源：`rules/` | v11.4.13（10 全量；v11：DESIGN 并入 FRONTEND、BESTPRACTICE 并入 GOVERNANCE）
...
- [FRONTEND.md](rules/FRONTEND.md) — ESLint/Prettier/Stylelint + Vue/React 组件规范 + 设计系统（DESIGN.md token 规范）
