...
> **版本**: v20.23 (v11.4.18) | **日期**: 2026-09-03 | **脚本**: `scripts/sync.ps1` | **常量单源**: `config/sync-manifest.json`
>
...
## DSH / OpenCode 适配层（v11.4.18；手工对齐，不覆盖 AGENTS.md）
...
| 版本映射 | DSH 2.12 ↔ Claude 11.4.18 | OpenCode 1.12 ↔ Claude 11.4.18 |
