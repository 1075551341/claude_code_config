...
> 五柱 × 五阶段 × 三横切 | **v11.4.14** | 归属: `MANIFEST.yaml` | 法典: `SPEC.md`（变更史: `CHANGELOG.md`）
...
- 当前：**v11.4.14**（2026-09-03）— 场景路由加载器闭环；Stop/Guard 消费审前双图与 inherit 并行门；sync.ps1 复制 harness 便携件。Guard 1.2.12；DSH 2.12 / OpenCode 1.12
