...
> 五柱 × 五阶段 × 三横切 | **v11.3.3** | 归属: `MANIFEST.yaml` | 法典: `SPEC.md`（变更史: `CHANGELOG.md`）
...
- 当前：**v11.3.3**（2026-08-16）— R20 增加文件/配置须与文档/备注一致；全局加载口径统一 L0–L3（SPEC 误标 SDD 为 L2、L4 残留已清）
