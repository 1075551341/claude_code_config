...
> 五柱 × 五阶段 × 三横切 | **v10.6.0** | 归属: `MANIFEST.yaml` | 法典: `SPEC.md` | 运行时: `docs/RUNTIME_PLAYBOOK.md`
...
| 目录 | 内容 |
|------|------|
| `skills/` | 44 技能（→ [skills-INDEX.md](skills-INDEX.md)） |
...
- 当前：**v10.6.0**（2026-07-29）— 版本对齐 + 文档精简 + CORE 瘦身 + hooks 治理
- 变更史：`SPEC.md` 末尾 changelog 链
- 调研 SSOT：`docs/research/30-repo-deep-research-v10.md` + `COVERAGE.md`
