...
136 个独立、可复用的技能模块，AI 可直接调用处理特定任务。
...
| **RULES_AGENTS.md**   | Agent    | Agent 定义、角色规范、工具约束     |
| **RULES_WORKFLOW.md** | 工作流   | Phase 工作流、任务分解、上下文腐败治理 |
